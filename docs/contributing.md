...
├── skills/design/            # Règles de conception
├── skills/development/       # Règles de développement
├── skills/audits/            # Orchestration et sous-skills d'audit
...
1. Créer le fichier dans `skills/design/`, `skills/development/`, `skills/audits/` ou `agents/`.
2. Le référencer dans `skills/audits/SKILL.md` lorsque nécessaire.
...
ln -s ../../skills/audits .claude/skills/audits
